...
class Server {
  ...
  initialize () {
    return new Promise((resolve, reject) => {
      ...
      this.bus.on('connected', () => {
        ...
        this.client = new Client(this.options.bus, this.options.rabbot)
  ...
  execute (name, params) {
    return new Promise((resolve, reject) => {
      ...
      const serviceSuccess = this._publishers[serviceName + '.Success']
      const serviceError = this._publishers[serviceName + '.Error']
      service.execute(params)
        .then((result) => {
          if (serviceSuccess) {
            serviceSuccess.publish(result, () => {
