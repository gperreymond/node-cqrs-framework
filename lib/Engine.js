      ...
      _.map(files, (filepath) => {
        ...
        if (typeof handler === 'function') {
          ...
          if (type !== 'None') {
            ...
            // receivers
            let receiver = new Rabbus.Receiver(name)
            ...
            // publishers
            let publisher = new Rabbus.Publisher(this.services[name].EventSuccess)
            this.publishers[this.services[name].EventSuccess] = publisher
            publisher = new Rabbus.Publisher(this.services[name].EventError)
